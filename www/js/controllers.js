...
.controller('DashCtrl', function($scope, $firebaseArray, $state, $timeout, $ionicLoading) {
    ...
    .controller('dashFilterCtrl', function($scope, $state) {
...
.controller('postCtrl', function($scope, $firebaseArray, $cordovaCamera, $state) {
        ...
        var configCamera = {
            ...
            destinationType: 0,
            sourceType: 0
                // 0 es la galería 1 es la camara

        };

        $scope.getPhoto = function() {
            $cordovaCamera.getPicture(configCamera).then(function(imageURI) {
    ...
    .controller('dashDetailChatCtrl', function($scope, $state) {
        $scope.$on('$ionicView.beforeEnter', function(event, viewData) {
            viewData.enableBack = true;
        });
...
.controller('PopupCtrl', function($scope, $ionicPopup) {
    ...
    $scope.showPopup = function() {
        ...
        var myPopup = $ionicPopup.show({
            template: '',
            title: 'Aquí podrás editar tu foto de perfil',
